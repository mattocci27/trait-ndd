...
```{r}
dry_abund[[3]]
print_summary_tbl(dry_abund[[1]], dry_abund[[2]], alpha = 0.05)

dry_trait[[3]]
print_summary_tbl(dry_trait[[1]], dry_trait[[2]], alpha = 0.05)

wet_abund[[3]]
print_summary_tbl(wet_abund[[1]], wet_abund[[2]], alpha = 0.05)

wet_trait[[3]]
print_summary_tbl(wet_trait[[1]], wet_trait[[2]], alpha = 0.05)
```
