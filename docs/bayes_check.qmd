...
generate_coef_abund_data <- function(draws, data, season = "Dry") {
...
bind_rows(
  generate_coef_abund_data(dry_abund$draws, dry_abund$data, season = "Dry"),
  generate_coef_abund_data(wet_abund$draws, wet_abund$data, season = "Rainy")) |>
  ggplot(aes(y = para)) +
