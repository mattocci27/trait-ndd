...
draws_df <- tar_read(fit_draws_multilevel_logistic_het_season_ba)
post <- tar_read(fit_mcmc_multilevel_logistic_het_season_ba)

d1 <- tar_read(het_season_ba)
s1 <- tar_read(fit_summary_multilevel_logistic_het_season_ba) |>
