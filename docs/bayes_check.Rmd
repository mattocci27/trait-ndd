...
```{r}
targets::tar_load(beta_cons_sdmc)
targets::tar_load(beta_cons_chl)
targets::tar_load(beta_cons_c)
```

```{r}
beta_cons_sdmc + beta_cons_chl + beta_cons_c
```
...
```{r}
targets::tar_load(beta_rain_ldmc)
targets::tar_load(beta_rain_c)
targets::tar_load(beta_rain_sla)
```

```{r}
beta_rain_ldmc + beta_rain_c + beta_rain_sla
```

```{r}
targets::tar_load(beta_consrain_ldmc)
targets::tar_load(beta_consrain_lt)
targets::tar_load(beta_consrain_c13)
targets::tar_load(beta_consrain_tlp)
```

```{r}
beta_consrain_ldmc + beta_consrain_lt + beta_consrain_c13 + beta_consrain_tlp
```
