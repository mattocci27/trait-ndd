...
$$
logit(p_{jlt}) = \boldsymbol{\beta_{j}} \cdot \boldsymbol{X}
$$
...
```{r,eval = T}
writeLines(readLines("../model/model_simple.stan"))
```
...
fit <- stan(file = "../model/model_simple.stan",
              data = list_dat,
          iter = 2000,
          warmup = 1000,
          thin = 1,
...
```{r, eval=TRUE}
save.image("../data/model_simple.rda")
```
