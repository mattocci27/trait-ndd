...
for (n in 1:length(files)) {
  ...
  if (str_detect(file_name, "Full w")) {
    tr_name <- c("Int", "StemD", "logSLA", "logLT")
  } else if (str_detect(file_name, "SDMC")) {
    tr_name <- c("Int", "StemD", "logSLA", "logC13")
  } else if (str_detect(file_name, "WD")) {
    tr_name <- c("Int", "PC1", "PC2")
  } else if (str_detect(file_name, "PC2")) {
    tr_name <- c("Int", "WD")
  } else if (str_detect(file_name, "PC3")) {
    tr_name <- c("Int", "WP")
  }
