...
```{r, include=FALSE}
wet_pca_gamma <- read_csv(here("data", "wet_intrain4_pc12_gamma.csv"))
```
...
gen_si_tab renders "ConS $\\times$ Rainfall" as expected but render_diagnostics_tables does not. I don't know why.
