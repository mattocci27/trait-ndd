...
```{r, include=FALSE}
dry_traits_gamma <- read_csv(here("data", "dry_norain_nlog_gamma.csv"))
```
...
```{r, include=FALSE}
dry_pca_gamma <- read_csv(here("data", "dry_intrain2_pc12_gamma.csv"))
```
...
```{r, include=FALSE}
wet_traits_gamma <- read_csv(here("data", "wet_norain_nlog_gamma.csv"))
```
...
```{r, include=FALSE}
wet_pca_gamma <- read_csv(here("data", "wet_intrain2_pc12_gamma.csv"))
```
