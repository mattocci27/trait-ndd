...
s_append_full <- captioner::captioner(prefix = "Appendix S", auto_space = FALSE)
...
s_append <- pryr::partial(s_append_full, display = "cite", caption = "blank")
...
s_append_num <- function (name) {s_append(name) %>% str_remove("Appendix ")}
